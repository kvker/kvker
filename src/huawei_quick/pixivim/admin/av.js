AV.init({
  appId: "s3sELwHfygmjzxQdAn2dhFxB-gzGzoHsz",
  appKey: "ehg5jgYdTmigV4HqnxCWM206",
  serverURL: "https://s3selwhf.lc-cn-n1-shared.com"
})
...
window.av = {
  ...
  uploadWithUrl: function(url, file_name) {
    if(!file_name) {
      file_name = dayjs().valueOf() + '.png'
    }
    return AV.File.withURL(
      file_name,
      url
    ).save()
  },
